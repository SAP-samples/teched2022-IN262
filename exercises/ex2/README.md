...
2. Select “Vendors” – This is where one would configure all Vendors in your organization which will be used for an application or an integration technology


3. Select “Create” to create a new Vendor. 

4. Name newly created Vendor as TechEd_SW_Provider_XX where XX is your assigned number. ** Note ** that instruction would say vendor as TechEd_SW_Provider_TR. Change TR to XX where XX is your assigned number. Select “Create” to create the vendor
