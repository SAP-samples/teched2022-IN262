...
<br><img src="/intro/images/1.2.0 ISAM_Wheel.PNG" width=80% height=80%>
...
<br><img src="/intro/images/1.6.2 Sample Integration Roles.PNG" width=80% height=80%>

## Integration Governance - Motivation
<br><img src="/intro/images/1.7.0 Integration Tool Motivation.PNG" width=80% height=80%>

### SAP Integration Suite Integration Assessment
<br><img src="/intro/images/1.7.1 Integration Tool Assessment.PNG" width=80% height=80%>

### Jumpstart your Integration Governance Practice
<br><img src="/intro/images/1.7.2 Jump Start Integration Governance.PNG" width=80% height=80%>

### Enables an Agile Integration Practice
<br><img src="/intro/images/1.7.3 INTAS Personas.PNG" width=80% height=80%>

### Business Value
<br><img src="/intro/images/1.8.0 Business Value.PNG" width=80% height=80%>
